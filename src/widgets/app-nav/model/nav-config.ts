...
/** Конфиг пунктов главной навигации приложения (порядок: дашборд → счета → категории → бюджеты → планирование → транзакции → профиль). */
export const APP_NAV_ITEMS: NavItem[] = [
    ...
    { name: ROUTE_NAMES.PROFILE, label: 'Профиль', icon: UserOutlined }
]
